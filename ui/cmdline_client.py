...
parser.add_argument("-c", "--command", choices = [ "status", "cont-status", "getpattern", "setpattern", "clr", "center", "trim", "movelr" ], default = "status", help = "Command to execute. Can be one of %(choices)s, defaults to %(default)s.")
